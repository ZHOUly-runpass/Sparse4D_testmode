...
# ================== local mini debug override ==================
# 当前本地无 NVIDIA GPU，本配置主要用于后续服务器 mini debug。
# 本地只检查路径和配置，不建议直接训练。
...
data_basic_config["version"] = "v1.0-mini"
...
# ================== modality setting ==================
# 原始 Sparse4D 不包含 radar branch。
# 该配置作为后续接入 radar loader / radar encoder 的实验配置。
